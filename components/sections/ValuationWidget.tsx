          ...
          <div className="bg-white rounded-lg p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select className="w-full px-4 py-3 rounded-lg border border-gray-300 text-gray-900 focus:ring-2 focus:ring-primary-500 focus:border-transparent">
            ...
            <Link
              ...
              className="block w-full mt-6 bg-primary-600 text-white text-center px-8 py-4 rounded-lg text-lg font-semibold hover:bg-primary-700 transition"
            >
