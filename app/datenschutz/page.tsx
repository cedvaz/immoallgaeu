      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            ...
            können Sie dem <Link href="/impressum" className="text-blue-600 hover:underline">Impressum</Link> dieser Website entnehmen.
          </p>

          <h4>Wie erfassen wir Ihre Daten?</h4>
          <p>
            Ihre Daten werden zum einen dadurch erhoben, dass Sie uns diese mitteilen. Hierbei kann es sich z.B. um
            Daten handeln, die Sie in ein Kontaktformular oder das Bewertungsformular eingeben.
          </p>
          <p>
          ...
          <p>
            Wenn Sie unser Online-Bewertungsformular nutzen, erfassen wir die von Ihnen eingegebenen Daten
            (Immobiliendetails, Kontaktdaten) zur Erstellung einer Bewertung und zur Kontaktaufnahme.
            Die Daten werden ausschließlich für diesen Zweck verwendet und nicht an Dritte weitergegeben.
          </p>
          <p>
            Die Verarbeitung erfolgt auf Grundlage Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO) und kann
            jederzeit widerrufen werden.
          </p>

          <h2>5. Newsletter (optional)</h2>
          <p>
            <em>
              Falls Sie einen Newsletter anbieten, fügen Sie hier entsprechende Informationen ein (Anbieter,
              Double-Opt-In-Verfahren, Widerrufsmöglichkeit, etc.)
            </em>
          </p>

          <h2>6. Analyse-Tools und Werbung (optional)</h2>
          <p>
            <em>
              Falls Sie Google Analytics, Facebook Pixel oder ähnliche Tools verwenden, müssen diese hier
              aufgeführt werden mit den entsprechenden Opt-Out-Möglichkeiten.
            </em>
          </p>
          ...
          <p className="mt-8 p-4 bg-yellow-50 border-l-4 border-yellow-600 text-sm">
            <strong>Hinweis:</strong> Diese Datenschutzerklärung ist eine Vorlage. Bitte passen Sie sie an
            Ihre tatsächliche Datenverarbeitung an und lassen Sie sie von einem Anwalt prüfen.
          </p>
        </div>
      </div>
    </main>
